...
function Navbar() {
  ...
  return (
    <div className={`max-w-screen-2xl container max-auto md:px-20 px-2 dark:bg-slate-900 dark:text-white  fixed top-0 left-0 right-0 z-50 ${sticky? "sticky-navbar shadow-md bg-base200   dark:bg-slate-600 dark:text-white  duration-300 transition-all ease-in-out":" "}`}>
 ...
 <label className="px-3 py-2 border rounded-md flex items-center gap-2  dark:bg-slate-900 dark:text-black">
